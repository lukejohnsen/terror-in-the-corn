...
<body>
    <div class="ticket-info-container">
        <div class="ticket-info-hero">
            ...
            <h3 class="ticket-hero-text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod
        ...
        <div class="admission-bullets-container">
            <div class="admission-bullets-left">
                <div class="admission-bullet">
                    <img src='../assets/fingerprint.png' class="fingerprint">
                    <p class="bullet-info">Regular Admission: tickets starting at $25.00 + tax (all ages, general
                        public line)</p>
                </div>

                <div class="admission-bullet">
                    <img src='../assets/fingerprint.png' class="fingerprint-alt">
